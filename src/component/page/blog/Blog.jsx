    ...
    return (
        <div className='container mx-auto'>
            ...
            <div className="text-center py-24" style={{ backgroundImage: `url(${banner})` }}>
                ...
                <h1 className="text-gray-800 text-4xl font-rubik font-bold pt-2">Welcome to The Blog</h1>
            </div>

            <h1 className="font-rubik px-12 font-bold pt-16  text-2xl"> <span className="underline decoration-orange-500 underline-offset-8">Latest </span>Blogs</h1>
            <div data-aos="fade-up"
                data-aos-anchor-placement="top-center" className='grid px-12 pt-5 gap-6 md:grid-cols-3'>
                <div className="">
                    <img className="w-full h-[260px] rounded-xl" src="https://i.ibb.co/7vW1PBM/category1.png" alt="" />
                    <div>
                        ...
                        <h1 className="text-xl font-bold pt-2">Name Name Name Name</h1>
                    </div>
                </div>
                <div className="">
                    <img className="w-full h-[260px] rounded-xl" src="https://i.ibb.co/7vW1PBM/category1.png" alt="" />
